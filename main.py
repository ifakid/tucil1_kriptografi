...
class SampleApp(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        self.frames = {}
        for F in (StartPage, Affine, Playfair, Vigenere, VigenereAuto, VigenereExt, VigenereFull, VigenereRun):
...
class StartPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        vig_run = tk.Button(self, text="Running-key Vigenere Cipher",
                             command=lambda: controller.show_frame("VigenereRun"))
...
class VigenereAuto(tk.Frame):
    def __init__(self, parent, controller):
        ...
        home = tk.Button(self, text="Home", command=lambda: controller.show_frame("StartPage"))
        home.grid(row=0, column=0, sticky="w")
        title = tk.Label(self, text="Auto-key Vigenere cipher")
        title.grid(row=0, column=1, sticky="w")
...
class VigenereExt(tk.Frame):
    ...
    def encrypt(self, file=False):
        if file:
            ...
            self.cipher.delete("1.0", tk.END)
            self.cipher.insert("1.0", cipher[:-1])
...
class VigenereFull(tk.Frame):
    def __init__(self, parent, controller):
        ...
        home = tk.Button(self, text="Home", command=lambda: controller.show_frame("StartPage"))
        home.grid(row=0, column=0, sticky="w")
        title = tk.Label(self, text="Full Vigenere cipher")
        title.grid(row=0, column=1, sticky="w")
...
class VigenereRun(tk.Frame):
    def __init__(self, parent, controller):
        ...
        home = tk.Button(self, text="Home", command=lambda: controller.show_frame("StartPage"))
        home.grid(row=0, column=0, sticky="w")
        title = tk.Label(self, text="Running-key Vigenere cipher")
        title.grid(row=0, column=1, sticky="w")
    ...
    def encrypt(self, file=False):
        if file:
            ...
            if not self.validate():
                return False
            text = self.plain.get("1.0", tk.END)
            cipher = vigenere_run.encode(text)
    ...
    def decrypt(self, file=False):
        if file:
            ...
            if not self.validate(encrypt=False):
                return False
            text = self.cipher.get("1.0", tk.END)
            plain = vigenere_run.decode(text)
